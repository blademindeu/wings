...
debug:
	go build -ldflags="-X github.com/blademindeu/wings/system.Version=$(GIT_HEAD)"
...
rmdebug:
	go build -gcflags "all=-N -l" -ldflags="-X github.com/blademindeu/wings/system.Version=$(GIT_HEAD)" -race
