...
import (
	...
	"github.com/blademindeu/wings/internal/progress"
	"github.com/blademindeu/wings/internal/ufs"
)
...
func (a *Archive) callback(opts ...walkFunc) walkFunc {
	...
	return func(dirfd int, name, relative string, d ufs.DirEntry) error {
		...
		//
		// See https://github.com/blademindeu/panel/issues/5030 for more details.
		if base != "" {
